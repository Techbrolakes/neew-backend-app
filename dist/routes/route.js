...
router.get("/newsletter/get", newsletter_service_1.default.get);
router.post("/newsletter/subscribe", newsletter_service_1.default.subscribe);
router.post("/newsletter/unsubscribe", newsletter_service_1.default.unsubscribe);
